<form action="{%$url.user%}?c=order&a=invoice" method="post" enctype="multipart/form-data" class="form-piao">
    ...
    <div class="upload-box">
        ...
        <div class="upload-dl box">
            ...
            <input type="text" name="VIN" value="{%$tplData.invoice.VIN%}"/>
        </div>
        <div class="upload-dl box">
            <div class="upload-dt">姓名：</div>
            <input type="text" name="name" value="{%$tplData.invoice.name%}"/>
        </div>
        <div class="upload-dl box">
            <div class="upload-dt">手机号：</div>
            <input type="text" name="phone" value="{%$tplData.invoice.phone%}"/>
        </div>
        <div class="upload-dl box">
            <div class="upload-dt">油卡寄送地址：</div>
            <input type="text" name="addr" value="{%$tplData.invoice.addr%}"/>
        </div>
        <div class="upload-dl box">
            <div class="upload-dt">备注：</div>
            <textarea  name="remark" maxlength="200" value="{%$tplData.invoice.remark%}"/>{%$tplData.invoice.remark%}</textarea>
        </div>
        ...
        <div class="upload-piao">
            ...
            <input class="img-input-hidden" name="imgsrc" value="{%$tplData.invoice.photo%}"  type="hidden"  />
