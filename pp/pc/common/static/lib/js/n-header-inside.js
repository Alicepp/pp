...
function setLoginBar(){
    ...
    if (window.userLoginInfo['url']) {
        loginBar.html(
            ...
            + '<ul class="slideCon">'
            + '<li id="notice_num"><a href="'+ window.URL.iUrl +'/homecp/message/notice/read/1" target="_blank"><span>消息</span><em></em></a></li>'
            + '<li id="atme_num"><a href="'+ window.URL.iUrl +'/homecp/message/user/read/1" target="_blank"><span>@我</span><em></em></a></li>'
            + '<li id="comment_num"><a href="'+ window.URL.iUrl +'/homecp/message/sys/read/1" target="_blank"><span>评论</span><em></em></a></li>'
            + '<li id="follow_num"><a href="'+ window.URL.iUrl+ "/" +window.userLoginInfo['id']+'/friend/list_1_1.html" target="_blank"><span>粉丝</span><em></em></a></li>'
            + '</ul>'
            + '</div>'
            + '<div class="head-set-handle" id="slide3">'
            + '<p><i class="set-handle-icon"></i></p>'
            + '<ul class="slideCon">'
            + '<li><a href="'+ window.URL.iUrl +'/homecp/user/userinfo/" target="_blank">账号设置</a></li>'
            + '<li><a href="'+ window.URL.iUrl +'/homecp/user/catverify/check/" target="_blank">猫友认证</a></li>'
            + '<li><a href="'+ window.URL.iUrl +'?callbackUrl='+nowPageUrl+'&act=logout" target="_blank">退出登录</a></li>'
            + '</ul>'
            + '</div>'
            + '</div>'
        );
