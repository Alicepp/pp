<script>
    window.emao=window.emao||{
        city:'常州',
        curCity:{%$tplData.curCity|json_encode|escape:none%},
        ...
        point:{%$point|json_encode|escape:none%},
        ...
        matrix: {%$tplData.parts.resource|json_encode|escape:none%},
        matrixKey:"{%$matrixKey%}",
    ...
    (function(){
        var hostUrl=("{%$hostUrl%}"||URL.home);
        var mHostUrl=("{%$mHostUrl%}"||URL.mHome);
        function local(id){
