<div class="car-price-box">
    <div class="car-price car-price3">
        <div class="price-lit">一猫价:<span class="mao-price emaoprice"><strong>{%$matrixItem.price|format_price:0%}</strong>{%$matrixItem.price|format_price:1%}</span></div>
        <div class="shi-price line-through">厂商指导价：<span class="guidePrice">{%$carInfo.price%}</span>万</div>
    </div>
...
<div class="dl-submit goods-type-{%$carInfo.__saleState%} mar-top10">
    <div class="qiang-btns" style="{%if $carInfo.isSeckill==1%}display:none;{%/if%}">
        ...
        <dl class="qiang-buy goods2 mar-top0">
            <dt>
