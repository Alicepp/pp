...
{%$brandList=[]%}
{%*$mobileUrl=($url.mHome|cat:'city/'|cat:$tplData.curCity.pinyin|cat:'/car-0-0-0-0-0-0-0-1.html')*%}
...
{%$FDATA=[
    ...
    'list'=>$sellList
        ...
        {%$urlLast="car-0-0-0-0-0-0-0-1.html" scope='global'%}
{%/block%}
{%block name="block_content"%}
<!--{%widget name="common:widget/navbar/nav.tpl" selectIndex=2 hasAllLine=1%}-->
