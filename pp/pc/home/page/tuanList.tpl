...
{%$brandList=[]%}
{%$mobileUrl=($url.mHome|cat:'city/'|cat:$tplData.curCity.pinyin|cat:'/juhuigou/list-0-1.html')%}
...
{%$FDATA=[
    ...
    'list'=>$sellList
        ...
        {%$urlLast="juhuigou/list-0-1.html" scope='global'%}
{%/block%}

{%block name="block_content"%}

{%widget name="home:widget/page/tuanList/page.tpl"%}
