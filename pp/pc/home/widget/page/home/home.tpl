...
<div class="wrapper pos-re clearfix">
   <!-- {%widget name="common:widget/navbar/nav.tpl" selectIndex=1 hasIndexLine=1%}-->
    <div class="sub-nav">
        <div class="nav-top"></div>
        <div class="nav-bottom"></div>
        <div class="nav-line-lf"></div>
        <div class="nav-line-rt"></div>
        <ul class="menu">
            <li>
                <h3><i></i>按品牌选车</h3>
            ...
            <div class="subcon">
                <div class="brand-hot">
                    ...
                    <ul class="hot-list">
                        {%foreach $tplData.hotBrandList as $k=>$hotList%}
                        <li>
                            <a href="{%get_searchurl brandId=$hotList.id%}" target="_blank">
                            ...
                            <dd>
                                {%foreach $alphaList as $lista%}
                                    {%foreach $lista as $list%}
                                        <a href="{%get_searchurl brandId=$list.id%}" target="_blank">
                                            {%$list.brandName%}
                                        </a>
                                    {%/foreach%}
                                {%/foreach%}
    ...
    <div class="slide">
        <div class="s_container">
            <ul class="slide-img">
                ...
                <li style="left:{%($i*900)%}px">
                    <a href="{%$list.linkUrl%}" target="_blank"><img style="width:100%;" src="{%$list.pic%}" alt=""/></a>
...
{%foreach $navData as $id=>$datas%}
    ...
    <div class="gg" style="margin-top: 10px;padding-bottom: 10px;"><a href="{%$tplData.bannerAd1.linkUrl%}" target="_blank"><img lazy-src="{%$tplData.bannerAd1.pic%}" alt=""/></a></div>
    {%/if%}
{%/foreach%}
